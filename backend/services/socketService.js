  ...
  async getRandomChallenge() {
    try {
      ...
      if (challenges.length === 0) {
        console.error('No challenges found in database, creating a default challenge');
        
        // Create a default Hello World challenge
        ...
        console.log("Created default Hello World challenge");
